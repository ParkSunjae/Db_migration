            ...
            <div class="bg_grey">
                <div class="main_inner">
                    <div class="data">
                        ...
                        <div v-if="nonSelect">이용약관 이전 버전 확인하기</div>
                        <div v-for="(con, index) in contentList" class="aTags">
                            <p @click="clickLink(con, index)" v-if="index != tempIndex" class="aTags">{{checkDate(con.createAt)}} 이용약관 보기</p>
                        </div>
                    </div>

                    <div class="intro_txt">
                        <p><a href="#">VORA소개</a> · <a href="#">설정</a> · <router-link :to="{name : 'TermsView' }" class="write_icon" tag="a">
                            개인정보처리방침
                        </router-link> · <router-link :to="{name : 'PrivacyView' }" class="write_icon" tag="a">
                            이용약관
                        </router-link></p>
